...
namespace Scraper.ViewModel.Logs
{
	public class TestTagViewModel
	{
		...
		public static TestTagViewModelCollection Create()
		{
			...
			{
				new TestTagViewModel("Berekeningen", TestTag.BEREKENINGEN, new TestTagViewModelCollection()
				{
					...
					new TestTagViewModel("ESIS", TestTag.BEREKENINGEN_ESIS, new TestTagViewModelCollection()
					{
					...
					new TestTagViewModel("Maximale hypotheek", TestTag.BEREKENINGEN_MAXIMALEHYPOTHEEK, new TestTagViewModelCollection()
					{
